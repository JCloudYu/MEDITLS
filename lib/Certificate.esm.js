...
//@export
async function __Client_Send_publicKey (buffer, write_stream) {
	...
	if( BitwiseCompareBE(__HEADER.__Server_Hello, deserializer.buffer) === 0 ) {
		const ecdh_publicKey = this.ecdh.generateKeys();		
...
export { __Client_Send_publicKey, __Server_Send_publicKey }